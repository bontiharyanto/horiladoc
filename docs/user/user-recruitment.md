# Recruitment — Panduan Pengguna

> Dokumen ini menjelaskan cara menggunakan modul **Recruitment** untuk pengguna aplikasi Horilla.
> Terakhir diperbarui: 2025-09-17.

---

## 1) Ringkasan Modul
- **Tujuan:** Mengelola lowongan, pelamar, dan proses seleksi hingga offering.
- **Siapa yang menggunakan:** HR & Recruiter; manager sebagai approver.
- **Tergantung pada:** Data jabatan/departemen, template email (opsional).
- **Izin minimal:** Melihat/membuat lowongan & kandidat; approval untuk manager.
...
2. Buka menu **Recruitment** dari sidebar.
...
- Gunakan *Pipeline Stages* (Screening → Interview → Offer) untuk melacak progres.
- Manfaatkan template email undangan interview dan pengingat.
