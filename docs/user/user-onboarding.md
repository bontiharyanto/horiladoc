# Onboarding — Panduan Pengguna

> Dokumen ini menjelaskan cara menggunakan modul **Onboarding** untuk pengguna aplikasi Horilla.
> Terakhir diperbarui: 2025-09-17.

---

## 1) Ringkasan Modul
- **Tujuan:** Memfasilitasi proses orientasi karyawan baru hingga siap bekerja.
- **Siapa yang menggunakan:** HR, Hiring Manager, Buddy (opsional), karyawan baru.
- **Tergantung pada:** Data karyawan, dokumen kontrak, daftar task onboarding.
- **Izin minimal:** Membuat paket onboarding; akses karyawan baru untuk checklist.
...
2. Buka menu **Onboarding** dari sidebar.
...
- Buat **Checklist Onboarding** (akun email, akses sistem, peralatan).
- Tetapkan PIC untuk tiap tugas agar jelas penanggung jawab.
