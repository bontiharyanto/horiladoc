# Performance Management System — Panduan Pengguna

> Dokumen ini menjelaskan cara menggunakan modul **Performance Management System** untuk pengguna aplikasi Horilla.
> Terakhir diperbarui: 2025-09-17.

---

## 1) Ringkasan Modul
- **Tujuan:** Penetapan target (OKR/KPI), penilaian periodik, dan umpan balik.
- **Siapa yang menggunakan:** Employee, Manager, HR/People Partner.
- **Tergantung pada:** Siklus penilaian, template KPI/kompetensi.
- **Izin minimal:** Employee (isi self-assessment), Manager (review/approve).
...
2. Buka menu **Performance** dari sidebar.
...
```mermaid
flowchart TD
  A[Mulai] --> B[Open Performance Management System]
...
- Gunakan **check-in berkala** untuk update progres.
- Dokumentasikan umpan balik untuk transparansi hasil review.
